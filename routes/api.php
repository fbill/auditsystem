...
Route::get('getPollsForCategory/{category_id}', 'PollController@getPollsForCategory');
Route::get('getPollDetailsForPollId/{poll_id}/{type}', 'PollDetailsController@getRegsForPollId');
